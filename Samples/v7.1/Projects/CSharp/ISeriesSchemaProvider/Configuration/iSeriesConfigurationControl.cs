...
{
    public partial class iSeriesConfigurationControl : UserControl, ISettingsControl
    {
        public iSeriesConfigurationControl()
        {
            InitializeComponent();
        }
        ...
        {
            get { return "Schema Provider|iSeries"; }
        }
        ...
        public void LoadSettings()
        {
            ...
            configPropertyGrid.SelectedObject = iSeriesConfiguration.Instance;
        }
