...
namespace SchemaExplorer
{
    ...
    /// Upgraded and enhanced for 3.5 by Erik Ejlskov @ http://erikej.blogspot.com
    /// </summary>
    public class SqlCompactSchemaProvider : IDbSchemaProvider, IDbConnectionStringEditor
    {
        ...
        public string Name
        {
            get { return "SqlCompactSchemaProvider"; }
        }
        ...
        {
            get { return "SQL Compact Schema Provider (v3.5 SP1)"; }
        }
        ...
        {
            SqlCompactConnectionStringEditor editor = new SqlCompactConnectionStringEditor(currentConnectionString);
