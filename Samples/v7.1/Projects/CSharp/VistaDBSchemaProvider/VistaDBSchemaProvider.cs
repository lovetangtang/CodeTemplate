...
{
    public class VistaDBSchemaProvider : IDbSchemaProvider, IDbConnectionStringEditor
    {
        ...
        public string Name
        {
            get { return "VistaDBSchemaProvider"; }
        }

        public string Description
        {
            get { return "SchemaExplorer Provider for VistaDB 3.x"; }
        }
        ...
        public TableSchema[] GetTables(string connectionString, DatabaseSchema database)
        {
            ...
            using (IVistaDBDatabase vistaDb = GetDatabase(connectionString))
            {
                ...
                foreach (string tableName in vistaDb.EnumTables())
                {
        ...
        public IndexSchema[] GetTableIndexes(string connectionString, TableSchema table)
        {
            ...
            using (IVistaDBDatabase vistaDb = GetDatabase(connectionString))
            {
                ...
                foreach (IVistaDBIndexInformation vistaIndex in vistaTable.Indexes)
                {
                    ...
                    extendedProperties.Add(ExtendedProperty.Readonly("CS_FastTextSearch", vistaIndex.FTS));
