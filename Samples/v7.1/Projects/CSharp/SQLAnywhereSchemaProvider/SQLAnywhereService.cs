...
{
    internal class SQLAnywhereService
    {
        #region Protected Member Variables
        protected string _connectionString = String.Empty;
        protected SAParameterCollection _parameterCollection;
        ...
        protected SAConnection _connection;
        protected SATransaction _transaction;
        protected int _commandTimeout = 30;
        #endregion Protected Member Variables
        
        #region Contructors
        public SQLAnywhereService()
        {
            _connectionString = ConfigurationManager.AppSettings["ConnectionString"];
        }
        
        public SQLAnywhereService(string connectionString)
        {
            _connectionString = connectionString;
        }
        
        public SQLAnywhereService(string server, string database, string user, string password)
        {
            string connectionstring = "uid=" + user + ";pwd=" + password + ";";
            if (database.Trim().Length != 0)
              connectionstring = "Database=" + database + ";" + connectionstring;
        ...
        public SQLAnywhereService(string server, string database)
        {
        ...
        public SQLAnywhereService(SAConnection connection)
        {
        ...
        {
            return new SafeDataReader(ExecuteSAReader(sql));
        }
        ...
        #region AddParameter
        public SAParameter AddParameter(string name, SADbType type, object value)
        {
        ...
        public SAParameter AddParameter(string name, DbType type, object value, bool convertZeroToDBNull)
        {
            SAParameter prm = new SAParameter();
            prm.Direction = ParameterDirection.Input;
            prm.ParameterName = name;
        ...
        public SAParameter AddParameter(string name, SADbType type, object value, int size)
        {
            SAParameter prm = new SAParameter();
            prm.Direction = ParameterDirection.Input;
            prm.ParameterName = name;
        ...
        public SAParameter AddParameter(string name, SADbType type, object value, int size, ParameterDirection direction)
        {
            SAParameter prm = new SAParameter();
            prm.Direction = direction;
            prm.ParameterName = name;
        ...
        public void AddParameter(SAParameter parameter)
        {
        ...
        public SAParameter AddOutputParameter(string name, SADbType type, int size)
        {
            SAParameter prm = new SAParameter();
            prm.Direction = ParameterDirection.Output;
            prm.ParameterName = name;
        ...
        public SAParameter AddReturnValueParameter()
        {
            SAParameter prm = new SAParameter();
            prm.Direction = ParameterDirection.ReturnValue;
            prm.ParameterName = "@ReturnValue";
            prm.SADbType = SADbType.Integer;
        ...
        public SAParameter AddStreamParameter(string name, Stream value)
        {
            return this.AddStreamParameter(name, value, SADbType.Image);
        }
        ...
        public SAParameter AddTextParameter(string name, string value)
        {
            SAParameter prm = new SAParameter();
            prm.Direction = ParameterDirection.Input;
            prm.ParameterName = name;
            prm.SADbType = SADbType.Text;
            prm.Value = this.PrepareSqlValue(value);
        ...
        {
            Hashtable attributes = new Hashtable( 10, StringComparer.InvariantCultureIgnoreCase );
