...
(?:\s*\=\s*(?<default>(?:'[^']*' | [\w]+)))?          # parameter default value";
        ...
        public void ValidForEnum(TableSchema table)
        {
            ...
            if (!IsValidEnumColumnType(table.PrimaryKey.MemberColumns[0]))
        ...
        public bool IsValidEnumColumnType(DataObjectBase column)
        {
            DbType[] types = new DbType[] { DbType.Byte, DbType.Int16, DbType.Int32, DbType.Int64, DbType.VarNumeric };
