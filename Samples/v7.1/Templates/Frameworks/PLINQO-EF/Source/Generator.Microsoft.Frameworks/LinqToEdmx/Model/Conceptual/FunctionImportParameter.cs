...
namespace LinqToEdmx.Model.Conceptual
{
  ...
  /// </para>
  /// </summary>
  public class FunctionImportParameter : XTypedElement, IXMetaData
  {
    private static readonly Dictionary<XName, Type> LocalElementDictionary = new Dictionary<XName, Type>();

    private static FSM _validationStates;

    static FunctionImportParameter()
    {
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TFunctionImportParameter", XMLNamespaceFactory.Edm);
      }
    }
    ...
    public static explicit operator FunctionImportParameter(XElement xe)
    {
      return XTypedServices.ToXTypedElement<FunctionImportParameter>(xe, LinqToXsdTypeManager.Instance);
    }
