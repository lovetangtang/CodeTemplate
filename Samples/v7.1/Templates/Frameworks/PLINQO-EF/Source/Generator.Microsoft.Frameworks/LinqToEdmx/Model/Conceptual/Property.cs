...
namespace LinqToEdmx.Model.Conceptual
{
  ...
  /// </para>
  /// </summary>
  public class Property : XTypedElement, IXMetaData
  {
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TProperty", XMLNamespaceFactory.Edm);
      }
    }
    ...
    public static explicit operator Property(XElement xe)
    {
      return XTypedServices.ToXTypedElement<Property>(xe, LinqToXsdTypeManager.Instance);
    }
