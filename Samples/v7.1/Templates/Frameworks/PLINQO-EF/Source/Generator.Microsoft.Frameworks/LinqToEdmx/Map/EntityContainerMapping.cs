  ...
  public class EntityContainerMapping : XTypedElement, IXMetaData
  {
    ...
    public IList<EntitySetMapping> EntitySetMappings
    {
      get
      {
        ...
        {
          _entitySetMappingField = new XTypedList<EntitySetMapping>(this, LinqToXsdTypeManager.Instance, XName.Get("EntitySetMapping", XMLNamespaceFactory.CS));
        }
      ...
      set
      {
        ...
        else
        {
          if ((_entitySetMappingField == null))
          {
            _entitySetMappingField = XTypedList<EntitySetMapping>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("EntitySetMapping", XMLNamespaceFactory.CS));
          }
          else
          {
    ...
    public IList<AssociationSetMapping> AssociationSetMappings
    {
      get
      {
        ...
        {
          _associationSetMappingField = new XTypedList<AssociationSetMapping>(this, LinqToXsdTypeManager.Instance, XName.Get("AssociationSetMapping", XMLNamespaceFactory.CS));
        }
      ...
      set
      {
        ...
        else
        {
          if ((_associationSetMappingField == null))
          {
            _associationSetMappingField = XTypedList<AssociationSetMapping>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("AssociationSetMapping", XMLNamespaceFactory.CS));
          }
          else
          {
    ...
    public IList<FunctionImportMapping> FunctionImportMappings
    {
      get
      {
        ...
        {
          _functionImportMappingField = new XTypedList<FunctionImportMapping>(this, LinqToXsdTypeManager.Instance, XName.Get("FunctionImportMapping", XMLNamespaceFactory.CS));
        }
      ...
      set
      {
        ...
        else
        {
          if ((_functionImportMappingField == null))
          {
            _functionImportMappingField = XTypedList<FunctionImportMapping>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("FunctionImportMapping", XMLNamespaceFactory.CS));
          }
          else
          {
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TEntityContainerMapping", XMLNamespaceFactory.CS);
      }
    }
    ...
    {
      LocalElementDictionary.Add(XName.Get("EntitySetMapping", XMLNamespaceFactory.CS), typeof (EntitySetMapping));
      LocalElementDictionary.Add(XName.Get("AssociationSetMapping", XMLNamespaceFactory.CS), typeof (AssociationSetMapping));
      LocalElementDictionary.Add(XName.Get("FunctionImportMapping", XMLNamespaceFactory.CS), typeof (FunctionImportMapping));
    }
  }
}