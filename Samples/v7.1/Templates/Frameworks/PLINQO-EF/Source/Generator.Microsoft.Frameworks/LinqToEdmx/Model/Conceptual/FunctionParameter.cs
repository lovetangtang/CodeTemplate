...
namespace LinqToEdmx.Model.Conceptual
{
  ...
  /// </para>
  /// </summary>
  public class FunctionParameter : XTypedElement, IXMetaData
  {
    ...
    public TCollectionType CollectionType
    {
      get
      {
        var x = GetElement(XName.Get("CollectionType", XMLNamespaceFactory.Edm));
    ...
    public ReferenceType ReferenceType
    {
      get
      {
        var x = GetElement(XName.Get("ReferenceType", XMLNamespaceFactory.Edm));
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TFunctionParameter", XMLNamespaceFactory.Edm);
      }
    }
    ...
    public static explicit operator FunctionParameter(XElement xe)
    {
      return XTypedServices.ToXTypedElement<FunctionParameter>(xe, LinqToXsdTypeManager.Instance);
    }
