...
namespace LinqToEdmx.Model.Conceptual
{
  ...
  /// </para>
  /// </summary>
  public class TypeRef : XTypedElement, IXMetaData
  {
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TTypeRef", XMLNamespaceFactory.Edm);
      }
    }
    ...
    public static explicit operator TypeRef(XElement xe)
    {
      return XTypedServices.ToXTypedElement<TypeRef>(xe, LinqToXsdTypeManager.Instance);
    }
