...
namespace LinqToEdmx.Model.Conceptual
{
  ...
  public class PropertyRef : XTypedElement, IXMetaData
  {
    ...
    XName IXMetaData.SchemaName
    {
      get
      {
        return XName.Get("TPropertyRef", XMLNamespaceFactory.Edm);
      }
    }
    ...
    private static void InitFsm()
    {
      ...
      transitions.Add(1, new Transitions(new SingleTransition(new WildCard("##other", XMLNamespaceFactory.Edm), 1)));
